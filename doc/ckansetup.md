...
* Manage [basic authorisation items](http://docs.ckan.org/en/latest/maintaining/authorization.html#configuration-file-options), like prevent unautorized users to create new data sets, or to dissallow datasets to be upload without assigning them to an organisation.
* Set up your [organisation](http://docs.ckan.org/en/latest/maintaining/authorization.html) structure and assign [organisation administrators](http://docs.ckan.org/en/latest/user-guide.html#managing-an-organization).
